    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title">POST A PROBLEM</h3>
        </div>
     ...
     <form action="" method="post"  >
         ...
         <div class="col-xs-12"><select class="form-control" name="category" >
                ...
                <option>Lack of Teachers </option>
                <option>Resources </option>
                <option>Studens </option>
    ...
    <input type="text" class="form-control"  data-role="tagsinput" name="tag"
     placeholder="Tags (maximum 5 tags)     "></input>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="submit"  class="btn btn-primary btn-md">SUBMIT PROBLEM</button>
