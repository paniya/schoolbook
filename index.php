...
$record_count = $conn->query("SELECT * FROM questions ");
//amount dispalyed
$per_page =3;
//number of pages
...
<div class="col-md-12">
 <button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal">
      <span class="glyphicon glyphicon-plus"></span> POST A PROBLEM
    </button></div></th>
<!-- question tab -->
...
if(isset($_POST['submit1'])){
  ...
  if(empty($uname)|| empty($pwrd)){
     echo '<div class="alert alert-danger alert-dismissable fade in">
          ...
          <center> <strong> Login Successful!</strong> missing data or some thing.
          </div></center>
          </div>';
  }else{
...
<div class="tab-content">
  ...
  <?php
include('db_connect.php');
$query1= $conn->prepare("SELECT q_id,category,body,tag,date FROM questions order by q_id desc  limit $start, $per_page");
$query1->execute();
